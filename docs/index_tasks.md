...
| [Refactoring Structurel](tasks/structural-refactoring.md) | Modularisation et nettoyage massif de l'architecture | 2026-03-20 | `Up to date` |
| [Refactoring Manager](tasks/agent-manager-refactoring.md) | Migration complète vers l'Agent Manager | 2026-03-20 | `Up to date` |
